    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                $sql = "SELECT * from `tblapplication` where UserID=$id limit 1";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    echo "<h1 class='align-center justify-content-center d-flex'><b>No Application Found For this User</b></h1><hr> 
                  <div class='d-flex justify-content-center'>  <a href='registered-users.php' class='btn btn-warning '><i class='fa-solid fa-arrow-left'></i> Go back</a> </div> ";
