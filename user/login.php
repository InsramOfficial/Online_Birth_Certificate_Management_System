...
if (isset($_SERVER['REQUEST_METHOD']) == 'POST' && isset($_POST['username']) & isset($_POST['password'])) {
    ...
    $sql = "SELECT * FROM `tbluser` where `FirstName`='$username'";
    ...
    if ($check && mysqli_num_rows($check) > 0) {
        ...
        if (md5($password) == $encpas) {
            ...
            echo $_SESSION['Address'] = $result['Address'];
            echo $_SESSION['RegDate'] = $result['RegDate'];
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <img style="width:500px;height:70vh;"
                                    src="https://i.pinimg.com/564x/bd/a3/17/bda3177a3943ffdbcc652b3a678a0d74.jpg"
                                    alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
